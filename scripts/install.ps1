<#
.SYNOPSIS
    Installs the latest bsdev release from GitHub.
.DESCRIPTION
    Run as Administrator to install for all users to $env:ProgramFiles\bsdev,
    or as a regular user to install to $env:LOCALAPPDATA\Programs\bsdev.
