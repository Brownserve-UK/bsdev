Thank you for submitting a PR to bsdev!
...
- [ ] Read the [contributing guide](https://github.com/Brownserve-UK/bsdev/blob/main/.github/CONTRIBUTING.md)
- [ ] Read our [code of conduct](https://github.com/Brownserve-UK/.github/blob/main/CODE_OF_CONDUCT.md)
- [ ] Verified that `cargo build --release` succeeds locally
- [ ] Verified that `cargo test --workspace` passes locally
